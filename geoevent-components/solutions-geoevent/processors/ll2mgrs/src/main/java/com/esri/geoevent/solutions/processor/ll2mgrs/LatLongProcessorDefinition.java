...
public class LatLongProcessorDefinition extends GeoEventProcessorDefinitionBase{
	private String lblMGRS = "${com.esri.geoevent.processor.latlong-mgrs-converter-processors.LBL_MGRS}";
	private String descMGRS= "${com.esri.geoevent.processor.latlong-mgrs-converter-processors.DESC_MGRS}";
	private String lblGeoField = "${com.esri.geoevent.processor.latlong-mgrs-converter-processors.LBL_GEO_FLD}";
	private String descGeoField= "${com.esri.geoevent.processor.latlong-mgrs-converter-processors.DESC_GEO_FLD_MGRS}";
	...
	private String lblOverwrite = "${com.esri.geoevent.processor.latlong-mgrs-converter-processors.LBL_OVERWRITE}";
	private String descOverwrite= "${com.esri.geoevent.processor.latlong-mgrs-converter-processors.DESC_OVERWRITE}";
	private String lblReturnBB = "${com.esri.geoevent.processor.latlong-mgrs-converter-processors.LBL_BB}";
	private String descReturnBB = "${com.esri.geoevent.processor.latlong-mgrs-converter-processors.DESC_BB}";
	...
	public String getLabel() {
		return "${com.esri.geoevent.processor.latlong-mgrs-converter-processors.LBL_MGRS2LL_PROCESSOR}";
	}

	@Override
	public String getDescription() {
		return "${com.esri.geoevent.processor.latlong-mgrs-converter-processors.DESC_MGRS2LL_PROCESSOR}";
	}
